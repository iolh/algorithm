...
function __quickSort0<T>(arr: T[], l: number, r: number): void {
  if (l >= r) {
    return;
  }
...
export function quickSort0<T>(arr: T[]): void {
...
function __quickSort1<T>(arr: T[], l: number, r: number): void {
  if (l >= r) {
    return;
  }
...
export function quickSort1<T>(arr: T[]): void {
...
export function quickSort2<T>(arr: T[]): void {
